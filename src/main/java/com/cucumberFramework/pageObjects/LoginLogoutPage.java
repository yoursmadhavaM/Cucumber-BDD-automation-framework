...
public class LoginLogoutPage {
	...
	public void clickSignInButton(){
		// Use direct or JS click to avoid Actions serialization issues with Selenium 3 + geckodriver
		try {
			SignInfromNav.click();
		} catch (Exception e) {
			((org.openqa.selenium.JavascriptExecutor) driver).executeScript("arguments[0].click();", SignInfromNav);
		}
	}
